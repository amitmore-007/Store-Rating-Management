...
//  * 
//  * Usage:
//  * - For local development: npm run setup-db
//  * - For production: node setup-database.js "your-postgres-url"
//  * 
//  * Note: This script is safe to run multiple times as it drops and recreates tables.
